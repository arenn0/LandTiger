...
extern void GLCD_DisplayChar    (unsigned int x, unsigned int y, unsigned char  c);
extern void GLCD_DisplayString  (unsigned int x, unsigned int y, unsigned char *s);
